// MangaEngine NCNN 推論橋（P1 去字 + P2 偵測）。handle-based：模型 createNet 載一次、
...
Java_mihon_feature_translation_engine_NcnnBackend_releaseNet(JNIEnv*, jobject, jlong handle) {
...
Java_mihon_feature_translation_engine_NcnnBackend_detectDbnetNative(
...
extern "C" JNIEXPORT jint JNICALL
Java_mihon_feature_translation_engine_NcnnBackend_inpaintAotNative(
        JNIEnv* env, jobject, jlong handle,

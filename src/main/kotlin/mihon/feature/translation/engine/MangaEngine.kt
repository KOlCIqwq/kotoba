package mihon.feature.translation.engine
 ...
 * MangaEngine.create(models, alphabet, apiKey).use { engine ->
...
object MangaEngine {
    ...
    fun create(
        ...
        val ocr = ocrOverride ?: Ocr(models.ocr, alphabet, config.ocr)
...
/** [MangaEngine.ocrAbTest] 結果：逐行 bilinear vs bicubic OCR 讀取 [rows] + 各內插法 recognize 總耗時（ms）+ 偵測耗時。 */
class OcrAbResult(
